...
then
    ...
    PARAM_FRP_CONFIG="https://raw.githubusercontent.com/youkie/v2ray/master/frpc.ini"

	PARAM_FRPS_CONFIG="https://raw.githubusercontent.com/youkie/v2ray/master/frps.ini"
	PARAM_V2RAYS_CONFIG="https://raw.githubusercontent.com/youkie/v2ray/master/configs.json"
...
then
	...
	curl -L -o frps.ini "${PARAM_FRPS_CONFIG}"
	curl -L -o configs.json "${PARAM_V2RAYS_CONFIG}"
